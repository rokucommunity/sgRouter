...
`sgRouter.setFocus` sets focus to the router outlet itself, typically called once during app initialization. It's not related to focus management within individual views.
